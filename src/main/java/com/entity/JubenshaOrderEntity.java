...
public class JubenshaOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JubenshaOrderEntity() {

	}

	public JubenshaOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "JubenshaOrder{" +
            "id=" + id +
            ", jubenshaOrderUuidNumber=" + jubenshaOrderUuidNumber +
            ", jubenshaId=" + jubenshaId +
            ", yonghuId=" + yonghuId +
            ", yuyueTime=" + yuyueTime +
            ", buyNumber=" + buyNumber +
            ", jubenshaOrderTruePrice=" + jubenshaOrderTruePrice +
            ", jubenshaOrderTypes=" + jubenshaOrderTypes +
            ", jubenshaOrderPaymentTypes=" + jubenshaOrderPaymentTypes +
