...
public class JubenshaCommentbackView extends JubenshaCommentbackEntity implements Serializable {
	...
	public JubenshaCommentbackView() {

	}

	public JubenshaCommentbackView(JubenshaCommentbackEntity jubenshaCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, jubenshaCommentbackEntity);
