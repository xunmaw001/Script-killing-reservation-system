...
public class JubenshaLiuyanView extends JubenshaLiuyanEntity implements Serializable {
	...
	public JubenshaLiuyanView() {

	}

	public JubenshaLiuyanView(JubenshaLiuyanEntity jubenshaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jubenshaLiuyanEntity);
