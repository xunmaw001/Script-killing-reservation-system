...
public class JubenshaOrderView extends JubenshaOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String jubenshaOrderValue;
		/**
		* 支付类型的值
		*/
		private String jubenshaOrderPaymentValue;
	...
	public JubenshaOrderView() {

	}

	public JubenshaOrderView(JubenshaOrderEntity jubenshaOrderEntity) {
		try {
			BeanUtils.copyProperties(this, jubenshaOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getJubenshaOrderValue() {
				return jubenshaOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setJubenshaOrderValue(String jubenshaOrderValue) {
				this.jubenshaOrderValue = jubenshaOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getJubenshaOrderPaymentValue() {
				return jubenshaOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setJubenshaOrderPaymentValue(String jubenshaOrderPaymentValue) {
				this.jubenshaOrderPaymentValue = jubenshaOrderPaymentValue;
			}
