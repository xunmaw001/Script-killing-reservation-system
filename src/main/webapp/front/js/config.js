...
var centerMenu = [
    ...
    ,{
        name: '剧本杀收藏',
        url: '../jubenshaCollection/list.html'
    }
    ,{
        name: '剧本杀订单',
        url: '../jubenshaOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '剧本杀',
        url: './pages/jubensha/list.html'
    },

]

var adminurl =  "http://localhost:8080/jubenshaguanli/admin/dist/index.html#/login";
